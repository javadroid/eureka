                ...
                <ScrollView style={{}}>
                    <View style={styles.registerContainer} >
                        ...
                        <View style={{ display: 'flex', flexDirection: 'row', }}>
                            <CustomInputText items={["f"]} styleContainer={{ width: '50%' }} errorText={formState.inputValidities['faculty']} initialValue={formState.inputValue['faculty']} onChangeText={onChangeTextHandler} editable={false} pickerRef={pickerFacultyRef} style={{ marginBottom: 0, }} id='faculty' label='Faculty' />
                            <CustomInputText items={["f"]} styleContainer={{ width: '50%' }} errorText={formState.inputValidities['department']} initialValue={formState.inputValue['department']} onChangeText={onChangeTextHandler} editable={false} pickerRef={pickerDepartmentRef} id='department' style={{ marginBottom: 0 }} label='Department' />
                        </View>
